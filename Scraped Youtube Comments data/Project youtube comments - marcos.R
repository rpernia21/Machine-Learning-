...
setwd("~/Documents/Data Science/R/Scraped Youtube Comments data")
...
# import raw data
clean_marcos_data <- read_csv("clean_marcos_data.csv", show_col_types = FALSE)
...
clean_corpus <- function(corpus){
  ...
  corpus <-tm_map(corpus, removeWords, c("ang", "toni", "marcos", "bbm", "marcoses", "interview", "youre", "yung",
                                         "mga","bongbong", "filipinos","philippines", "president","bong", "will", 
                                         "hindi", "para", "lang","ferdinand", "na",
                                         "sa", "ng", "ako", "sir", "just")) #dictionary
...
clean_corp <-tm_map(clean_corp, removeWords, c("ang", "toni", "marcos", "bbm", "marcoses", "interview", "youre", "yung",
                                           "mga","bongbong", "filipinos","philippines", "president","bong", "will", 
                                           "hindi", "para", "lang","ferdinand", "na",
                                           "sa", "ng", "ako", "sir", "just", "filipino", "pilipina", "pilipino"))
...
wordcloud(clean_corp,min.freq = 50, rot.per = .20)
...
processed <- textProcessor(clean_marcos_data$comments, metadata = clean_marcos_data,
                           ...
                           striphtml = FALSE, #*
                           customstopwords = c("ang", "toni", "marcos", "bbm", "marcoses", "interview", "youre", "yung",
                                               "mga","bongbong", "filipinos","philippines", "president","bong", "will", 
                                               "hindi", "para", "lang","ferdinand", "na",
                                               "sa", "ng", "ako", "sir", "just", "filipino", "pilipina", "pilipino"), #*
                           v1 = FALSE) #*
